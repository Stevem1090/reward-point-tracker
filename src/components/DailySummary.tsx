...
import { Award, Send, Star, Mail, MessageSquare } from 'lucide-react';
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <div className="flex gap-4 w-full">
            ...
            <Button 
              ...
              variant="secondary" 
              className="flex-1"
              disabled={!contactInfo.whatsapp || summary.entriesByCategory.length === 0}
            >
          ...
          {!contactInfo.email && !contactInfo.whatsapp && (
            <p className="text-sm text-center text-muted-foreground">
              Contact information not set. Please add your email or WhatsApp in the Settings tab.
            </p>
          )}
        </CardFooter>
      </Card>
